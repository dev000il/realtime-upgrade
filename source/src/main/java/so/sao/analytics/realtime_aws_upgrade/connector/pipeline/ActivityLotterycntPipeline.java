...
import so.sao.analytics.realtime_aws_upgrade.connector.filter.ActivityLotterFilter;
 ...
 * <li>ActivityLotterFilter</li>
 * </ul>
 */
public class ActivityLotterycntPipeline implements IKinesisConnectorPipeline<FlatActivity, ActivityCount> {
    ...
    public IFilter<FlatActivity> getFilter(KinesisConnectorConfiguration configuration) {
        return new ActivityLotterFilter();
    }
